          ...
          <div className="grid gap-0 lg:grid-cols-[1.1fr_0.9fr]">
            <div className="p-6 sm:p-8 lg:p-10">
              ...
              <div className="mt-8 space-y-4 rounded-[24px] border border-[#E5DDD0] bg-white/70 p-6">
                ...
                <a
                  ...
                  className="inline-flex h-[46px] items-center justify-center rounded-full bg-[#C8A45D] px-5 text-[14px] font-[600] text-white transition-all duration-300 hover:-translate-y-0.5 hover:bg-[#B79247]"
                >
                  Como chegar
                </a>
              </div>
            ...
            <div className="border-t border-[#E8DFD3] p-4 sm:p-6 lg:border-t-0 lg:border-l lg:p-6">
              <div className="overflow-hidden rounded-[24px] border border-[#E5DDD0] bg-white">
                <iframe
                  src="https://www.google.com/maps?q=Estrada%20de%20Santa%20Isabel%20965B%20Aruj%C3%A1%20SP&z=15&output=embed"
