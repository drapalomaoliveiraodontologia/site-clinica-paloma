    ...
    <section id="especialidades" className={`${manrope.className} scroll-mt-24 w-full bg-[#FCFAF7]`}>
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
        <Reveal delay={40} direction="up" className="mx-auto max-w-3xl text-center">
          ...
          <h2 className="text-[26px] leading-[1.15] font-[600] tracking-[-0.02em] text-[#171717] sm:text-[34px] lg:text-[36px]">
        ...
        <div className="mt-12 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
          {treatments.map((treatment, index) => (
            <Reveal key={treatment.title} delay={120 + index * 80} direction="up">
              <article className="group rounded-[24px] border border-[#E9E1D6] bg-white p-5 shadow-[0_12px_40px_rgba(17,17,17,0.05)] transition-all duration-300 hover:-translate-y-[6px] hover:shadow-[0_18px_50px_rgba(17,17,17,0.08)] sm:p-7">
